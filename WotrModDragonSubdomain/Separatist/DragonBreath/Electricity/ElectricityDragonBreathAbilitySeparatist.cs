...
{
    public class ElectricityDragonBreathAbilitySeparatist
    {
        public static readonly string AbilityName = "ElectricityDragonBreathAbilitySeparatist";
        public static readonly string AbilityGuid = "676736C2-F423-487F-A2F4-5FBF02834CEF"; // Unique GUID
        ...
        public static void Configure()
        {
            ...
            var electricityDragonBreathAttackSeparatist = ActionsBuilder
                .New()
                .SavingThrow(
            ...
            var electricityDragonBreathAbilitySeparatist = AbilityConfigurator
                ...
                .AddAbilityResourceLogic(amount: 1, isSpendResource: true, requiredResource: ElectricityDragonBreathResourceSeparatist.ResourceName)
                .AddAbilityEffectRunAction(electricityDragonBreathAttackSeparatist)
